...
// Re-fetch the server-localised priority inbox (+ stats + recent feed)
// when the user switches app language so "Perlu Perhatian" / "Needs
// Attention" labels follow the new locale without a manual page reload.
