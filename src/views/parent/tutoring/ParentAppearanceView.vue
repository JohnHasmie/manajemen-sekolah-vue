...
<template>
  <div class="space-y-4 pb-12">
    ...
    <section class="rounded-2xl border border-bimbel-border-soft bg-bimbel-panel p-4 space-y-3">
      <h4 class="text-[14px] font-bold tracking-tight text-bimbel-text-hi">Mode tampilan</h4>
      ...
      <div v-if="theme.mode === 'auto'" class="grid gap-2 sm:grid-cols-2 pt-2 border-t border-bimbel-border-soft">
        <label class="grid items-center gap-3" style="grid-template-columns: 140px 1fr;">
          <span class="text-[13px] text-bimbel-text-mid">Jam terang mulai</span>
          <input
            v-model="lightStart"
            type="time"
        ...
        <label class="grid items-center gap-3" style="grid-template-columns: 140px 1fr;">
          <span class="text-[13px] text-bimbel-text-mid">Jam gelap mulai</span>
          <input
            v-model="darkStart"
            type="time"
            class="rounded-lg border border-bimbel-border bg-bimbel-bg px-3 py-1.5 text-[13px] text-bimbel-text-hi focus:border-[#21afe6] focus:outline-none"
    ...
    <section class="rounded-2xl border border-bimbel-border-soft bg-bimbel-panel p-4 space-y-3">
      <h4 class="text-[14px] font-bold tracking-tight text-bimbel-text-hi">Bahasa</h4>
    ...
    <section class="rounded-2xl border border-bimbel-border-soft bg-bimbel-panel p-4">
      <h4 class="mb-2 text-[14px] font-bold tracking-tight text-bimbel-text-hi">Notifikasi</h4>
      <div
        v-for="row in [
