    ...
    <div v-else-if="filtered.length" class="space-y-2">
      ...
      >
        ...
        <div class="min-w-0 flex-1">
          <p class="text-[12.5px] font-bold text-bimbel-text-hi">{{ n.title }}</p>
          <p v-if="n.body" class="text-[11.5px] text-bimbel-text-mid">{{ n.body }}</p>
        </div>
        <span class="flex-shrink-0 text-[10.5px] text-bimbel-text-lo">{{ rel(n.created_at) }}</span>
