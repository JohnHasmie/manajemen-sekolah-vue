  ...
  <div class="space-y-4 pb-12">
    ...
    <div class="grid gap-4 lg:grid-cols-5">
      <aside class="rounded-2xl border border-bimbel-border-soft bg-bimbel-panel p-4 text-center lg:col-span-2 h-fit">
        ...
        <p class="text-[11px] text-bimbel-text-mid">Wali · {{ children.length }} anak terdaftar</p>
        <dl class="mt-4 space-y-1 text-left text-[11.5px]">
      ...
      <div class="space-y-3 lg:col-span-3">
        <section class="rounded-2xl border border-bimbel-border-soft bg-bimbel-panel p-4">
          <h4 class="mb-3 text-[12.5px] font-bold tracking-tight text-bimbel-text-hi">Identitas wali</h4>
          <div class="space-y-2.5">
            <label class="grid items-center gap-3" style="grid-template-columns: 140px 1fr;">
              <span class="text-[11.5px] text-bimbel-text-mid">Nama lengkap</span>
              <input
                type="text"
                :value="user?.name ?? ''"
            ...
            <label class="grid items-center gap-3" style="grid-template-columns: 140px 1fr;">
              <span class="text-[11.5px] text-bimbel-text-mid">Email</span>
              <input
                type="email"
                :value="user?.email ?? ''"
                disabled
            ...
            <label class="grid items-center gap-3" style="grid-template-columns: 140px 1fr;">
              <span class="text-[11.5px] text-bimbel-text-mid">No HP / WA</span>
              <input
                type="tel"
            ...
            <label class="grid items-start gap-3" style="grid-template-columns: 140px 1fr;">
              <span class="pt-1 text-[11.5px] text-bimbel-text-mid">Alamat</span>
              <textarea
                rows="2"
        ...
        <section class="rounded-2xl border border-bimbel-border-soft bg-bimbel-panel p-4">
          <h4 class="mb-3 text-[12.5px] font-bold tracking-tight text-bimbel-text-hi">Anak terdaftar</h4>
          ...
          <ul class="space-y-1.5">
            ...
            >
              ...
              <div class="min-w-0 flex-1">
                ...
                <p class="truncate text-[11px] text-bimbel-text-mid">{{ c.class_name }}</p>
              </div>
            </li>
          </ul>
          <button
            type="button"
            class="mt-3 inline-flex items-center gap-1 rounded-lg border border-bimbel-border bg-bimbel-panel px-3 py-1.5 text-[11.5px] font-bold text-bimbel-text-hi hover:bg-bimbel-border-soft"
        ...
        <section class="rounded-2xl border border-bimbel-border-soft bg-bimbel-panel p-4">
          <h4 class="mb-3 text-[12.5px] font-bold tracking-tight text-bimbel-text-hi">Keamanan</h4>
          <div class="grid items-center gap-3" style="grid-template-columns: 140px 1fr auto;">
            <span class="text-[11.5px] text-bimbel-text-mid">Kata sandi</span>
            <span class="text-[12px] text-bimbel-text-mid">Diperbarui beberapa waktu lalu</span>
            <button
              type="button"
              class="inline-flex items-center gap-1 rounded-lg border border-bimbel-border bg-bimbel-panel px-3 py-1.5 text-[11.5px] font-bold text-bimbel-text-hi hover:bg-bimbel-border-soft"
              @click="goToUbahSandi"
            >
