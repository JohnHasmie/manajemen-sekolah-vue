...
<template>
  <div class="space-y-4 pb-12">
    ...
    <div class="grid gap-4 lg:grid-cols-5">
      ...
      >
        <h4 class="text-[12.5px] font-bold tracking-tight text-bimbel-text-hi">Kata sandi baru</h4>
        <label class="block">
          <span class="block text-[11px] font-bold uppercase tracking-wider text-bimbel-text-mid">Sandi saat ini</span>
          <input
            v-model="current"
            type="password"
            required
        ...
        <label class="block">
          <span class="block text-[11px] font-bold uppercase tracking-wider text-bimbel-text-mid">Sandi baru</span>
          <input
            v-model="next"
            type="password"
            required
            ...
            class="mt-1 w-full rounded-lg border border-bimbel-border bg-bimbel-bg px-3 py-2 text-[12.5px] text-bimbel-text-hi focus:border-[#21afe6] focus:outline-none"
          />
          <span class="mt-0.5 block text-[10.5px] text-bimbel-text-lo">Minimal 8 karakter · campur huruf besar/kecil & angka</span>
        </label>
        <label class="block">
          <span class="block text-[11px] font-bold uppercase tracking-wider text-bimbel-text-mid">Konfirmasi sandi</span>
          <input
            v-model="confirm"
            type="password"
            required
        ...
        <div>
          <p class="text-[11px] font-bold uppercase tracking-wider text-bimbel-text-mid">Kekuatan sandi</p>
          ...
          <p class="mt-1 text-[11px]" :style="{ color: strengthColor }">{{ strengthLabel }}</p>
        </div>
        ...
        <div class="flex gap-2 pt-2">
          ...
          <button
            type="submit"
            :disabled="!canSubmit"
            class="flex-1 rounded-lg bg-emerald-600 px-3 py-2 text-[12.5px] font-bold text-white hover:opacity-90 disabled:opacity-50"
      ...
      <aside class="rounded-2xl border border-bimbel-border-soft bg-bimbel-panel p-4 lg:col-span-2 h-fit">
        <h4 class="mb-2 text-[12.5px] font-bold tracking-tight text-bimbel-text-hi">Tips sandi kuat</h4>
        <ul class="space-y-1.5 text-[11.5px] text-bimbel-text-mid list-disc pl-4">
