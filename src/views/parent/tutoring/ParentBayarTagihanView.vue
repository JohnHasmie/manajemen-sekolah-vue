  ...
  <div class="space-y-4 pb-12">
    ...
    <template v-else-if="bill">
      <div class="relative overflow-hidden rounded-2xl border border-bimbel-border-soft bg-bimbel-panel pl-5 pr-4 py-3.5">
        ...
        <p class="text-[12px] font-bold uppercase tracking-widest text-emerald-700 dark:text-emerald-300">TAGIHAN AKTIF</p>
      ...
      <div class="grid gap-4 lg:grid-cols-5">
        ...
        >
          <h4 class="text-[13px] font-bold tracking-tight text-bimbel-text-hi">Detail pembayaran</h4>
          <div>
            <p class="text-[12px] font-bold uppercase tracking-wider text-bimbel-text-mid">Metode <span class="text-rose-500">*</span></p>
            <div class="mt-2 grid gap-2 sm:grid-cols-2">
              ...
              >
                ...
                <div><p class="text-[13px] font-bold text-bimbel-text-hi">Transfer bank</p><p class="text-[12px] text-bimbel-text-mid">Verifikasi manual</p></div>
              </button>
              <button
                type="button"
                class="flex items-center gap-3 rounded-xl border p-3 text-left transition"
              ...
              >
                ...
                <div><p class="text-[13px] font-bold text-bimbel-text-hi">QRIS</p><p class="text-[12px] text-bimbel-text-mid">Scan & bayar</p></div>
              </button>
            </div>
          </div>
          <div class="grid gap-3 sm:grid-cols-2">
            <label class="block">
              <span class="block text-[12px] font-bold uppercase tracking-wider text-bimbel-text-mid">Jumlah ditransfer <span class="text-rose-500">*</span></span>
              <input
            ...
            <label class="block">
              <span class="block text-[12px] font-bold uppercase tracking-wider text-bimbel-text-mid">Tanggal transfer <span class="text-rose-500">*</span></span>
              <input
                v-model="payDate"
                type="date"
                required
          ...
          <label class="block">
            <span class="block text-[12px] font-bold uppercase tracking-wider text-bimbel-text-mid">Nama pengirim</span>
            <input
              v-model="senderName"
              type="text"
          ...
          <div>
            <p class="text-[12px] font-bold uppercase tracking-wider text-bimbel-text-mid">Bukti transfer <span class="text-rose-500">*</span></p>
            <label class="mt-2 flex cursor-pointer flex-col items-center gap-1 rounded-xl border-2 border-dashed border-bimbel-border py-6 text-center text-[12px] text-bimbel-text-mid hover:border-[#21afe6]">
              ...
              <span class="text-[12px] text-bimbel-text-lo">JPG / PNG / PDF · maks 5MB</span>
              <span v-if="fileName" class="text-[12px] font-semibold text-bimbel-text-hi">{{ fileName }}</span>
              <input type="file" class="hidden" accept="image/*,application/pdf" @change="onFile" />
            </label>
          </div>
          <label class="block">
            <span class="block text-[12px] font-bold uppercase tracking-wider text-bimbel-text-mid">Catatan</span>
            <textarea v-model="notes" rows="2" placeholder="Opsional" class="mt-1 w-full rounded-lg border border-bimbel-border bg-bimbel-bg px-3 py-2 text-[13px] text-bimbel-text-hi focus:border-[#21afe6] focus:outline-none"></textarea>
          </label>
        ...
        <aside class="space-y-3 lg:col-span-2">
          ...
          <div class="rounded-2xl border border-bimbel-border-soft bg-bimbel-panel p-4">
            ...
            <ul class="space-y-1 text-[12px] text-bimbel-text-mid list-disc pl-4">
