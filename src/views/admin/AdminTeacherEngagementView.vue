      ...
      <template v-else-if="payload">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
          <div class="rounded-2xl bg-white border border-slate-100 shadow-sm p-4">
            ...
            <p class="text-xl font-black text-slate-900 mt-2">{{ payload.meta.kpi.total_teachers }}</p>
          </div>
          <div class="rounded-2xl bg-white border border-slate-100 shadow-sm p-4">
            <p class="text-3xs font-bold text-slate-500 uppercase tracking-widest">Aktif minggu ini</p>
            <p class="text-xl font-black text-slate-900 mt-2">{{ payload.meta.kpi.active_this_week }}</p>
          </div>
          <div class="rounded-2xl bg-white border border-slate-100 shadow-sm p-4">
            ...
            <p class="text-xl font-black text-slate-900 mt-2">
              {{ payload.meta.kpi.average_streak }}<span class="text-3xs font-bold text-slate-500 ml-1">hari</span>
            </p>
          </div>
          <div class="rounded-2xl bg-white border border-slate-100 shadow-sm p-4">
            <p class="text-3xs font-bold text-slate-500 uppercase tracking-widest">Perlu perhatian</p>
            <p class="text-xl font-black text-slate-900 mt-2">{{ payload.meta.kpi.needs_attention_count }}</p>
          </div>
        </div>
