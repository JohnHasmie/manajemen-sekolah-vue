...
<template>
  <div class="space-y-4 pb-12">
    ...
    >
      <template #actions>
        <button class="rounded-lg bg-white text-bimbel-accent px-3 py-1.5 text-[13px] font-bold">Simpan</button>
      </template>
    </TutorBerandaHero>
    ...
    <div class="grid gap-4 lg:grid-cols-5">
      <aside class="rounded-2xl border border-bimbel-border-soft bg-bimbel-panel p-4 text-center lg:col-span-2 h-fit">
        ...
        <p class="text-[12px] text-bimbel-text-mid">Admin · {{ user?.school_name ?? 'Bimbel' }}</p>
      ...
      <div class="space-y-3 lg:col-span-3">
        <section class="rounded-2xl border border-bimbel-border-soft bg-bimbel-panel p-4 space-y-2.5">
          ...
          <label class="grid items-center gap-3" style="grid-template-columns: 140px 1fr;">
            <span class="text-[13px] text-bimbel-text-mid">Nama</span>
        ...
        <section class="rounded-2xl border border-bimbel-border-soft bg-bimbel-panel p-4 space-y-2.5">
          ...
          <label class="grid items-center gap-3" style="grid-template-columns: 140px 1fr;">
            <span class="text-[13px] text-bimbel-text-mid">Nama bimbel</span>
          ...
          <label class="grid items-center gap-3" style="grid-template-columns: 140px 1fr;">
            <span class="text-[13px] text-bimbel-text-mid">No telp kantor</span>
        ...
        <section class="rounded-2xl border border-bimbel-border-soft bg-bimbel-panel p-4">
          ...
          <div class="grid items-center gap-3" style="grid-template-columns: 140px 1fr auto;">
            ...
            <button type="button" class="inline-flex items-center gap-1 rounded-lg border border-bimbel-border bg-bimbel-panel px-3 py-1.5 text-[13px] font-bold text-bimbel-text-hi hover:bg-bimbel-border-soft" @click="router.push({ name: 'admin.tutoring.change-password' })">
