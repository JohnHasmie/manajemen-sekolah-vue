...
async function submit() {
  ...
  try {
    ...
    message.value = { kind: 'ok', text: 'Sandi diperbarui.' };
...
<template>
  <div class="space-y-4 pb-12">
    ...
    <TutorBerandaHero greeting="UBAH SANDI" title="Ubah kata sandi" subtitle="Gunakan sandi kuat dan tidak dipakai di akun lain" :stats="[]" />
