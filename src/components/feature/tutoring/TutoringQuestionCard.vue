...
<template>
  <article
    class="bg-white border border-slate-100 rounded-2xl p-4 mb-2"
  >
    ...
    <ul class="mt-2 space-y-1">
      <li
        ...
        :key="oi"
        class="text-sm"
        :class="o.is_correct ? 'font-bold text-status-success' : 'text-slate-700'"
      >
        {{ o.label }}. {{ o.text }}
      </li>
    </ul>
    <p
      ...
      class="mt-2 text-xs font-bold text-status-success"
    >
