...
const _kDbPresenceToday = {'en': 'Presence today', 'id': 'Kehadiran hari ini'};
const _kDbActiveStudents = {'en': 'Active students', 'id': 'Siswa aktif'};
const _kDbStudentsTaught = {'en': 'Students taught', 'id': 'Siswa diampu'};
...
const _kPdParent = {'en': 'Parent', 'id': 'Wali Murid'};
