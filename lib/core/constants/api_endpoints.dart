...
class ApiEndpoints {
  ...
  static const attendanceTeacherCalendar = '/attendance/teacher-calendar';
  static const attendanceLastSession = '/attendance/last-session';
  ...
  static const gradesAdminRecapOverview = '/grades/admin-recap-overview';
