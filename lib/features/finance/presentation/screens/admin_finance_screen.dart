...
class FinanceScreenState extends ConsumerState<FinanceScreen> {
  ...
  Widget _buildSelectionSummary() {
    ...
    return Row(
      ...
      children: [
        ...
        if (totalClasses == _classList.length &&
  ...
  void _showAddEditPaymentType({Map<String, dynamic>? paymentType}) {
    final namaController = TextEditingController(text: paymentType?['name']);
    ...
    final jumlahController = TextEditingController(
      text: paymentType?['amount'] != null
          ? NumberFormat.currency(
              ...
              symbol: 'Rp ',
              decimalDigits: 0,
            ).format(double.tryParse(paymentType!['amount'].toString()) ?? 0)
          : '',
    );
                        ...
                        children: [
                          ...
                          InkWell(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                color: goalData != null && goalData!.isNotEmpty
  ...
  Future<void> _confirmGenerateBills(Map<String, dynamic> paymentType) async {
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        // Info Pembayaran
                        _buildInfoItem('Siswa', payment['siswa_nama'] ?? '-'),
                        _buildInfoItem('Kelas', payment['kelas_nama'] ?? '-'),
                        _buildInfoItem(
                          languageProvider.getTranslatedText(
                            ...
                            onPressed: () async {
                              try {
                                await _apiService.put(
                                  ...
                                  {
                                    'status': status,
                                    'admin_notes': notesController.text.isEmpty
                                        ? null
  ...
  Widget _buildPembayaranPendingCard(Map<String, dynamic> payment, int index) {
    return Container(
      margin: EdgeInsets.symmetric(horizontal: 16, vertical: 4),
      child: Material(
        color: Colors.transparent,
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildInfoRow('Jumlah', _formatCurrency(payment['amount'])),
                  ],
                ),
              ),
            ],
