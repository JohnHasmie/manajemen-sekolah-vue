...
/// `n['id'].toString()`).
 String get id;/// Notification category, e.g. 'bill', 'class_activity', 'announcement'.
/// Nullable: navigation compared the raw value and cards/dialogs applied
/// their own `?? 'general'` fallback.
 String? get type;/// Headline text. Nullable; call sites applied `?? '-'` / `?? 'Informasi'`.
 String? get title;/// Body text. Nullable; call sites applied `?? '-'` / `?? ''`.
 String? get body;/// ISO timestamp string, passed straight into the date formatter which
/// already accepts `String?`.
@JsonKey(name: 'created_at') String? get createdAt;/// Derived unread flag. True when the source row should be treated as
/// unread, preserving the original rule: bool → `!is_read`; int →
/// `is_read != 1`; anything else / missing → unread (true).
@JsonKey(name: 'is_unread') bool get isUnread;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NotificationItem&&(identical(other.id, id) || other.id == id)&&(identical(other.type, type) || other.type == type)&&(identical(other.title, title) || other.title == title)&&(identical(other.body, body) || other.body == body)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.isUnread, isUnread) || other.isUnread == isUnread));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,type,title,body,createdAt,isUnread);

@override
String toString() {
  return 'NotificationItem(id: $id, type: $type, title: $title, body: $body, createdAt: $createdAt, isUnread: $isUnread)';
}
...
@useResult
$Res call({
 String id, String? type, String? title, String? body,@JsonKey(name: 'created_at') String? createdAt,@JsonKey(name: 'is_unread') bool isUnread
});
...
/// Create a copy of NotificationItem
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? type = freezed,Object? title = freezed,Object? body = freezed,Object? createdAt = freezed,Object? isUnread = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String? type,  String? title,  String? body, @JsonKey(name: 'created_at')  String? createdAt, @JsonKey(name: 'is_unread')  bool isUnread)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _NotificationItem() when $default != null:
return $default(_that.id,_that.type,_that.title,_that.body,_that.createdAt,_that.isUnread);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String? type,  String? title,  String? body, @JsonKey(name: 'created_at')  String? createdAt, @JsonKey(name: 'is_unread')  bool isUnread)  $default,) {final _that = this;
switch (_that) {
case _NotificationItem():
return $default(_that.id,_that.type,_that.title,_that.body,_that.createdAt,_that.isUnread);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String? type,  String? title,  String? body, @JsonKey(name: 'created_at')  String? createdAt, @JsonKey(name: 'is_unread')  bool isUnread)?  $default,) {final _that = this;
switch (_that) {
case _NotificationItem() when $default != null:
return $default(_that.id,_that.type,_that.title,_that.body,_that.createdAt,_that.isUnread);case _:
  return null;
...
class _NotificationItem implements NotificationItem {
  const _NotificationItem({required this.id, this.type, this.title, this.body, @JsonKey(name: 'created_at') this.createdAt, @JsonKey(name: 'is_unread') this.isUnread = true});
...
/// unread, preserving the original rule: bool → `!is_read`; int →
/// `is_read != 1`; anything else / missing → unread (true).
@override@JsonKey(name: 'is_unread') final  bool isUnread;
...
/// Create a copy of NotificationItem
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? type = freezed,Object? title = freezed,Object? body = freezed,Object? createdAt = freezed,Object? isUnread = null,}) {
