...
class TeacherMaterialScreenState extends ConsumerState<TeacherMaterialScreen> {
  ...
  void _navigateToGenerateRPP() async {
    ...
    if (checkedChapters.isEmpty && checkedSubChapters.isEmpty) {
      SnackBarUtils.showInfo(
        context,
        'Pilih minimal 1 bab atau sub bab untuk di-generate',
      );
      return;
    }
    ...
    if (checkedSubChapters.isNotEmpty) {
      ...
      AppLogger.debug(
        'material',
        'Selected sub-chapter: $selectedSubChapterId, parent chapter: $selectedChapterId',
      );
    }
  ...
  int _getCheckedCount() {
    final chapterChecked = _checkedChapter.values
