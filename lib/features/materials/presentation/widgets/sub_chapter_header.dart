                  ...
                  children: [
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Icon(
                          isSheet ? Icons.close : Icons.arrow_back,
                          color: Colors.white,
                          size: 18,
                        ),
                      ),
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(
                            'Bab ${chapter['urutan']} · Sub ${subChapter['urutan']}',
                            style: TextStyle(
                              fontSize: 11,
                          ...
                          Text(
                            subChapter['judul_sub_bab'] ?? 'Sub Bab',
