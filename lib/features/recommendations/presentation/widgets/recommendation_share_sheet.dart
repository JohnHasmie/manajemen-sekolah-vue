        ...
        children: [
          ...
          Expanded(
            child: ListView(
              ...
              children: [
                const _FieldLabel('Penerima'),
                const SizedBox(height: 6),
                _buildRecipientList(cobalt),
                const SizedBox(height: 14),
                const _FieldLabel('Nada Pesan'),
                const SizedBox(height: 6),
                _buildToneGrid(cobalt),
                const SizedBox(height: 14),
                const _FieldLabel('Catatan Tambahan', trailing: '· opsional'),
                const SizedBox(height: 6),
                _buildMessageInput(cobalt),
                const SizedBox(height: 14),
                const _FieldLabel('Pratinjau Pesan'),
                const SizedBox(height: 6),
                _buildPreview(cobalt),
                const SizedBox(height: 14),
                const _FieldLabel('Kanal Pengiriman'),
                const SizedBox(height: 6),
