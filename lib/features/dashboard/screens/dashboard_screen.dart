...
class _DashboardState extends ConsumerState<Dashboard> with TickerProviderStateMixin {
  ...
  Future<void> _prefetchAllTours() async {
    try {
      ...
      final completedList = await ApiTourService.getCompletedTours(platform: 'mobile');
      ...
      if (_effectiveRole == 'admin') {
        tourEntries.addAll([
          (role: 'admin', name: 'student_management_tour', cacheKey: CacheKeyBuilder.tourStatus('student_management', 'admin')),
          (role: 'admin', name: 'teacher_admin_tour', cacheKey: CacheKeyBuilder.tourStatus('teacher_admin_screen', 'admin')),
          (role: 'admin', name: 'admin_class_management_tour', cacheKey: CacheKeyBuilder.tourStatus('class_management', 'admin')),
          (role: 'admin', name: 'subject_management_tour', cacheKey: CacheKeyBuilder.tourStatus('subject_management', 'admin')),
          (role: 'admin', name: 'teaching_schedule_management_tour', cacheKey: CacheKeyBuilder.tourStatus('schedule_management', 'admin')),
          (role: 'admin', name: 'admin_announcement_tour', cacheKey: CacheKeyBuilder.tourStatus('announcement', 'admin')),
          (role: 'admin', name: 'admin_class_activity_tour', cacheKey: CacheKeyBuilder.tourStatus('class_activity', 'admin')),
          (role: 'admin', name: 'admin_presence_report_tour', cacheKey: CacheKeyBuilder.tourStatus('presence_report', 'admin')),
          (role: 'admin', name: 'admin_rpp_screen_tour', cacheKey: CacheKeyBuilder.tourStatus('rpp_screen', 'admin')),
          (role: 'admin', name: 'admin_raport_screen_tour', cacheKey: CacheKeyBuilder.tourStatus('raport_screen', 'admin')),
          (role: 'admin', name: 'admin_finance_screen_tour', cacheKey: CacheKeyBuilder.tourStatus('finance', 'admin')),
          (role: 'admin', name: 'admin_school_settings_tour', cacheKey: CacheKeyBuilder.tourStatus('school_settings', 'admin')),
        ]);
      }
      ...
      if (_effectiveRole == 'guru') {
        tourEntries.addAll([
          (role: 'guru', name: 'input_grade_tour', cacheKey: CacheKeyBuilder.tourStatus('input_grade_screen', 'guru')),
          (role: 'guru', name: 'teaching_schedule_tour', cacheKey: CacheKeyBuilder.tourStatus('teaching_schedule_screen', 'guru')),
          (role: 'guru', name: 'class_activity_tour', cacheKey: CacheKeyBuilder.tourStatus('class_activity_screen', 'guru')),
          (role: 'guru', name: 'presence_teacher_tour', cacheKey: CacheKeyBuilder.tourStatus('presence_teacher_screen', 'guru')),
          (role: 'guru', name: 'materi_screen_tour', cacheKey: CacheKeyBuilder.tourStatus('materi_screen', 'guru')),
          (role: 'guru', name: 'rekap_nilai_tour', cacheKey: CacheKeyBuilder.tourStatus('rekap_nilai_screen', 'guru')),
          (role: 'guru', name: 'raport_screen_tour', cacheKey: CacheKeyBuilder.tourStatus('raport_screen', 'guru')),
          (role: 'guru', name: 'raport_detail_screen_tour', cacheKey: CacheKeyBuilder.tourStatus('raport_detail_screen', 'guru')),
          (role: 'guru', name: 'rpp_screen_tour', cacheKey: CacheKeyBuilder.tourStatus('rpp_screen', 'guru')),
          (role: 'walimurid', name: 'announcement_screen_tour', cacheKey: CacheKeyBuilder.tourStatus('announcement_screen', 'guru')),
          (role: 'guru', name: 'learning_recommendation_class_tour', cacheKey: CacheKeyBuilder.tourStatus('recommendation_class_screen', 'guru')),
          (role: 'guru', name: 'learning_recommendation_student_tour', cacheKey: CacheKeyBuilder.tourStatus('recommendation_student_screen', 'guru')),
          (role: 'guru', name: 'learning_recommendation_result_tour', cacheKey: CacheKeyBuilder.tourStatus('recommendation_result_screen', 'guru')),
        ]);
      }
      ...
      if (_effectiveRole == 'wali') {
        tourEntries.addAll([
          (role: 'walimurid', name: 'announcement_screen_tour', cacheKey: CacheKeyBuilder.tourStatus('announcement_screen', 'wali')),
          (role: 'wali', name: 'parent_class_activity_screen_tour', cacheKey: CacheKeyBuilder.tourStatus('parent_class_activity_screen', 'wali')),
          (role: 'wali', name: 'parent_grade_screen_tour', cacheKey: CacheKeyBuilder.tourStatus('parent_grade_screen', 'wali')),
          (role: 'wali', name: 'parent_billing_screen_tour', cacheKey: CacheKeyBuilder.tourStatus('parent_billing_screen', 'wali')),
          (role: 'wali', name: 'parent_presence_screen_tour', cacheKey: CacheKeyBuilder.tourStatus('parent_presence_screen', 'wali')),
        ]);
      }

      // 3. Check each tour against the completed set and cache results
      for (final entry in tourEntries) {
        final isCompleted = completedSet.contains('${entry.name}|${entry.role}');
    ...
    TutorialCoachMark(
      ...
      onFinish: () {
        getIt<ApiTourService>().completeTour(
          name: 'dashboard_tour', role: _effectiveRole, platform: 'mobile',
        );
      },
