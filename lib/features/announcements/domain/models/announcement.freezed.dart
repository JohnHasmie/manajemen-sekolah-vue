...
mixin _$Announcement {
 ...
 String get id; String get title; String get content; String get category;@JsonKey(name: 'created_at') String? get createdAt;// Default true — treats missing `is_read` as read/unknown,
// matching existing UI semantics (unread requires explicit false/0).
@JsonKey(name: 'is_read') bool get isRead;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,content,category,createdAt,isRead);

@override
String toString() {
  return 'Announcement(id: $id, title: $title, content: $content, category: $category, createdAt: $createdAt, isRead: $isRead)';
}
...
@useResult
$Res call({
 String id, String title, String content, String category,@JsonKey(name: 'created_at') String? createdAt,@JsonKey(name: 'is_read') bool isRead
});
...
/// Create a copy of Announcement
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? title = null,Object? content = null,Object? category = null,Object? createdAt = freezed,Object? isRead = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String title,  String content,  String category, @JsonKey(name: 'created_at')  String? createdAt, @JsonKey(name: 'is_read')  bool isRead)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Announcement() when $default != null:
return $default(_that.id,_that.title,_that.content,_that.category,_that.createdAt,_that.isRead);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String title,  String content,  String category, @JsonKey(name: 'created_at')  String? createdAt, @JsonKey(name: 'is_read')  bool isRead)  $default,) {final _that = this;
switch (_that) {
case _Announcement():
return $default(_that.id,_that.title,_that.content,_that.category,_that.createdAt,_that.isRead);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String title,  String content,  String category, @JsonKey(name: 'created_at')  String? createdAt, @JsonKey(name: 'is_read')  bool isRead)?  $default,) {final _that = this;
switch (_that) {
case _Announcement() when $default != null:
return $default(_that.id,_that.title,_that.content,_that.category,_that.createdAt,_that.isRead);case _:
  return null;
...
class _Announcement extends Announcement {
  const _Announcement({required this.id, required this.title, required this.content, required this.category, @JsonKey(name: 'created_at') this.createdAt, @JsonKey(name: 'is_read') this.isRead = true}): super._();
...
/// Create a copy of Announcement
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? title = null,Object? content = null,Object? category = null,Object? createdAt = freezed,Object? isRead = null,}) {
