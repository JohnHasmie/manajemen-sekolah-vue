    ...
    return Container(
      ...
      child: DropdownButtonFormField<String>(
        ...
        items: [
          ...
          DropdownMenuItem(value: 'admin', child: Text(kAnnRoleAdmin.tr)),
          DropdownMenuItem(value: 'teacher', child: Text(kAnnTeachers.tr)),
          DropdownMenuItem(value: 'student', child: Text(kAnnStudents.tr)),
          DropdownMenuItem(value: 'parent', child: Text(kAnnParents.tr)),
        ],
        onChanged: onChanged,
        style: TextStyle(fontSize: 14, color: ColorUtils.slate800),
      ),
