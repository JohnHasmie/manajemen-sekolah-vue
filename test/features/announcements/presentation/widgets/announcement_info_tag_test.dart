  ...
  group('AnnouncementInfoTag — rendering', () {
    testWidgets('renders icon', (tester) async {
      await tester.pumpWidget(
        _build(icon: Icons.access_time_outlined, text: '1 Jan 2025'),
      );
    ...
    testWidgets('renders people icon', (tester) async {
      await tester.pumpWidget(
        _build(icon: Icons.people_outline, text: 'Semua'),
      );
    ...
    testWidgets('text has maxLines=1 and ellipsis overflow', (tester) async {
      await tester.pumpWidget(
        _build(text: 'Teks yang sangat panjang dan perlu dipotong'),
      );
