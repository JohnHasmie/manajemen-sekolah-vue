  ...
  group('ParentAttendanceInfoTag', () {
    testWidgets('renders without crashing', (tester) async {
      await tester.pumpWidget(
        _build(icon: Icons.calendar_today_outlined, text: '10 Mar 2025'),
      );
    ...
    testWidgets('displays text label', (tester) async {
      await tester.pumpWidget(
        _build(icon: Icons.access_time_outlined, text: 'Jam 1'),
      );
    ...
    testWidgets('displays the icon', (tester) async {
      await tester.pumpWidget(
        _build(icon: Icons.calendar_today_outlined, text: 'date'),
      );
      expect(
    ...
    testWidgets('renders without tagColor (uses default slate color)', (
      tester,
    ) async {
    ...
    testWidgets('icon size is 10', (tester) async {
      await tester.pumpWidget(
        _build(icon: Icons.access_time_outlined, text: 'Jam 2'),
      );
      final icon = tester.widget<Icon>(
        find.byWidgetPredicate(
          (w) => w is Icon && w.icon == Icons.access_time_outlined,
        ),
      );
      expect(icon.size, 10);
    });
