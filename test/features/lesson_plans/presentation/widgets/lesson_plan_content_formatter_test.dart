...
void main() {
  ...
  group('LessonPlanContentFormatter.stripHtml', () {
    ...
    test('converts <br> and <br/> to newlines', () {
      final result = LessonPlanContentFormatter.stripHtml('line1<br>line2<br/>line3');
    ...
    test('converts <ul><li> to bullet points', () {
      final html = '<ul><li>Item A</li><li>Item B</li></ul>';
  ...
  group('LessonPlanContentFormatter.format', () {
    ...
    test('picks up "judul" as the title field', () {
      final result = LessonPlanContentFormatter.format({'judul': 'Fisika Dasar'});
      expect(result, contains('Fisika Dasar'));
    });

    test('falls back to "title" when "judul" is absent', () {
      final result = LessonPlanContentFormatter.format({'title': 'Basic Physics'});
    ...
    test('includes KEGIATAN PEMBELAJARAN section with sub-sections when all three activity fields are given', () {
      final result = LessonPlanContentFormatter.format({
